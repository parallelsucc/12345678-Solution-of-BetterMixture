...
# new
# cache home
export DATA_JUICER_CACHE_HOME="${SCRIPT_DIR}/../cache"
# cache models
export DATA_JUICER_MODELS_CACHE="${SCRIPT_DIR}/../cache/models"
# cache assets
export DATA_JUICER_ASSETS_CACHE="${SCRIPT_DIR}/../cache/assets"
